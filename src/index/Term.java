...
public final class Term {
    ...
    /** poids du terme dans la requ�te */
    public short weigth;
     ...
     * @see TermFrequency
     */
    public TreeMap<Integer, TermFrequency> frequency;
    ...
    // {
    public Term(int id, String text, TreeMap<Integer, TermFrequency> frequency) {
	this.term_id = id;
	this.text = text;
	// this.freq = freq;
	// this.doc_count = doc_nb;
	this.frequency = new TreeMap<Integer, TermFrequency>();
